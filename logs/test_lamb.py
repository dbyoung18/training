...
class RefLAMB(Optimizer):
    ...
    def step(self, closure=None):
        ...
        global_grad_norm = multi_tensor_applier(self.multi_tensor_l2norm,
                                                ...
                                                [[g_norm_32, g_norm_16]],
                                                False)[0]
        g_norm_32_ =  torch.zeros(1, device=device)
        for i in range(len(g_all_32)):
            g_norm_32_ += g_all_32[i].pow(2).sum()
        g_norm_32_ = g_norm_32_.sqrt()
        # print(g_all_32)
        # print("g_norm_32_", g_norm_32_, len(g_all_32))
        # print("g_norm_32", g_norm_32)
